...
import { Button, Col, Form, Input, InputNumber, Row, Select, Spin, Switch, notification,
} from "antd";
...
import { useCreateCasinoListQuery, useLazyCreateParentListQuery } from "../../../store/service/supermasteAccountStatementServices";
...
const NewCreateUser = ({ createName, userTyep  }) => {
  ...
  return (
    <>
      ...
      {
        userTypeCheck != userTyep && <SelectUpline data={resultData?.data} handleChange={handleChange} handleSelect={handleSelect}/>
      }
      
      {
        (parentId?.length > 0 ||  userTypeCheck == userTyep) &&  <div className="main_live_section">
        ...
        <div className="ant-spin-nested-loading">
          ...
          <Form
            ...
            <div>
              ...
              <MatchCommission createName={createName} commissionType={commissionType} commiType={commiType} data={data} userData={userData}/>
